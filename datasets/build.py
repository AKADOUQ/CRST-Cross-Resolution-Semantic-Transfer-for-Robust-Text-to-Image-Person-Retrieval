...
def build_dataloader(args, tranforms=None, test_res_label=0):
    logger = logging.getLogger("CRST.dataset")

    num_workers = args.num_workers

    if args.dataset_name == 'CUHK-PEDES':
        dataset = __factory[args.dataset_name](root=args.root_dir, img_subdir=args.img_subdir)
    else:
    ...
    if args.training:
        ...
        test_img_set = ImageDataset(ds['image_pids'], ds['img_paths'],
                                    test_transforms, res_label=test_res_label)
